...
<html lang="en">
  <head>
	...
	<title><g:layoutTitle default="Pelican : ${message(code: "administration")}" /></title>
...
<body>
	...
	<div id="seeking-developers-container" class="alert alert-warning">
		<g:message code="interested.contributing"/>
	</div>
	
	<div id="pelican-header"></div>
	...
	<div id="outer-container" style="position:relative">
		...
		<div id="content-container">
			...
			<a href="http://www.openabc.xyz" target="_blank" id="abc-link" title="ABC : Simple Open Source SMB Software"><img src="${resource(dir:'images/app/pelican-icon.png')}" style="height:inherit;width:inherit;outline:none;"/></a>
			
			
			<div id="header">
				<div class="header-info pull-left align-left">
					<g:message code="welcome.back"/> <strong><sec:username/></strong>!
					<g:link controller="logout" action="index"><g:message code="logout"/></g:link>
				</div>

				<div class="header-info pull-right align-right">
